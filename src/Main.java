...
/* Ответ на 4 вопрос
[((())()(())]] - данная последовательность не является верной, т.к. не каждая открывающая скобка должна иметь свою пару.
Т.е. верная последовательность должна выглядеть так: [((())()(()))]. Не существовало открывающей скобки для пары: [].
 */
